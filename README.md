...
webassemblу и неизвестный тогда Kotlin Multiplatform. Отсутствие специалистов по C/C++ сократило наши
...
- Ограничения. Учитывая что вы пишите общий код, этот код должен работать везде и работать одинаково, а значит то, что
  ...
  общем коде нет. Под специфичными платформами я имею в виду, что вы можете использовать некоторые особенности
  платформы с
